...
for (var extension in geppettoConfig.extensions) {
    if (geppettoConfig.extensions[extension]) {
        var geppettoExtension = path.resolve(__dirname, 'extensions', extension);
...
module.exports = function(env){
  ...
  // admin: "./js/pages/admin/admin.js"
	var entries = {
        main: "./extensions/geppetto-netpyne/ComponentsInitialization.js",
	};
    ...
    return {
	    ...
	    plugins: [
	        ...
	        new webpack.DefinePlugin({
              ...
              "EXTENSION": JSON.stringify(geppettoExtension)
	        }),
